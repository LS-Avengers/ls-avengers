...
flyer.addToActions('read', (function() {
  return 'Come visit Olympus Park for the LambdaSchool Hacka-... No, you read that wrong... this is just talking about a lawyer convention, you should go!';
}).bind(flyer));
...
camera.addToActions('snap', function() { // take picture
